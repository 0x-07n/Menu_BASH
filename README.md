# Script de Gestion Système en Bash

Ce script Bash offre diverses fonctionnalités pour la gestion et la surveillance d'un système Linux. Il inclut des options pour mettre à jour les paquets, gérer les utilisateurs, surveiller les ressources système, et plus encore.

## Table des Matières

1. [Auto Update](#auto-update)
2. [Lister les Utilisateurs](#lister-les-utilisateurs)
3. [Créer un Utilisateur](#créer-un-utilisateur)
4. [Supprimer un Utilisateur](#supprimer-un-utilisateur)
5. [Nslookup d'un Domaine](#nslookup-dun-domaine)
6. [Installer BTOP](#installer-btop)
7. [Afficher BTOP](#afficher-btop)
8. [Afficher la Configuration Réseau](#afficher-la-configuration-réseau)
9. [Surveiller l'Espace Disque](#surveiller-lespace-disque)
10. [Lister les PID en Cours](#lister-les-pid-en-cours)
11. [Supprimer les Processus Utilisateur](#supprimer-les-processus-utilisateur)
12. [Effectuer un Ping](#effectuer-un-ping)
13. [Afficher les Statistiques de la RAM](#afficher-les-statistiques-de-la-ram)
14. [Afficher les Statistiques du CPU](#afficher-les-statistiques-du-cpu)
15. [Effacer l'Écran](#effacer-lécran)
16. [Quitter](#quitter)
